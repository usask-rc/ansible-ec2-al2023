...
If you get an error that the user process is in use it means you already started Ubuntu as yourself. You can restart and try again, but this time do not start Ubuntu as yourself, just go in as root first. You can also delete your old home directory, so you don't accidentally put anything there in the future:
